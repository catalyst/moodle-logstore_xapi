...
/**
 * Transformer utility to determine the course result.
 *
 ...
 * @return array
 */
function get_course_result(array $config, \stdClass $gradeitem, \stdClass $grade) {
    $gradesum = floatval($grade->finalgrade ?? 0);
    ...
    $scaledscore = $gradesum !== 0 ? get_scaled_score($rawscore, $minscore, $maxscore) : 1;
