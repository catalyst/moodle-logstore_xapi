...
namespace logstore_xapi\mod_bigbluebuttonbn\recording_published;
...
/**
 * Unit test for mod_bigbluebuttonbn recording published event.
 *
 ...
 */
class recording_published_test extends \logstore_xapi\xapi_test_case {
