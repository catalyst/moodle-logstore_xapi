...
namespace logstore_xapi\mod_bigbluebuttonbn\meeting_created;
...
/**
 * Unit test for mod_bigbluebuttonbn meeting created event.
 *
 ...
 */
class meeting_created_test extends \logstore_xapi\xapi_test_case {
