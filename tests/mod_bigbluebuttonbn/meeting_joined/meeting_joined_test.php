...
namespace logstore_xapi\mod_bigbluebuttonbn\meeting_joined;
...
/**
 * Unit test for mod_bigbluebuttonbn meeting joined event.
 *
 ...
 */
class meeting_joined_test extends \logstore_xapi\xapi_test_case {
