...
namespace logstore_xapi\mod_bigbluebuttonbn\meeting_ended;
...
/**
 * Unit test for mod_bigbluebuttonbn meeting ended event.
 *
 ...
 */
class meeting_ended_test extends \logstore_xapi\xapi_test_case {
