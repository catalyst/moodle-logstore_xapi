...
namespace logstore_xapi\mod_bigbluebuttonbn\recording_deleted;
...
/**
 * Unit test for mod_bigbluebuttonbn recording deleted event.
 *
 ...
 */
class recording_deleted_test extends \logstore_xapi\xapi_test_case {
