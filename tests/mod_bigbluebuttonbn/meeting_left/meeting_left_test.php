...
namespace logstore_xapi\mod_bigbluebuttonbn\meeting_left;
...
/**
 * Unit test for mod_bigbluebuttonbn meeting left event.
 *
 ...
 */
class meeting_left_test extends \logstore_xapi\xapi_test_case {
