...
namespace logstore_xapi\mod_bigbluebuttonbn\recording_viewed;
...
/**
 * Unit test for mod_bigbluebuttonbn recording viewed event.
 *
 ...
 */
class recording_viewed_test extends \logstore_xapi\xapi_test_case {
