...
namespace logstore_xapi\mod_scorm\status_submitted\existing_status_submitted;
...
/**
 * Unit test for mod_scorm status submitted event.
 *
 ...
 */
class existing_status_submitted_test extends \logstore_xapi\xapi_test_case {
