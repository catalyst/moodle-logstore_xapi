...
namespace logstore_xapi\mod_scorm\scoreraw_submitted\existing_scoreraw_submitted;
...
/**
 * Unit test for mod_scorm scoreraw submitted event.
 *
 ...
 */
class existing_scoreraw_submitted_test extends \logstore_xapi\xapi_test_case {
