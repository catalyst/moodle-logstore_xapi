...
namespace logstore_xapi\mod_quiz\attempt_submitted\gapselect;
...
/**
 * Unit test for mod_quiz attempt submitted (gap select) event.
 *
 ...
 */
class gapselect_test extends \logstore_xapi\xapi_test_case {
