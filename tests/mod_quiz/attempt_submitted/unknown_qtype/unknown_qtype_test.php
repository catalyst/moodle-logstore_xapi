...
namespace logstore_xapi\mod_quiz\attempt_submitted\unknown_qtype;
...
/**
 * Unit test for mod_quiz attempt submitted (unknown type) event.
 *
 ...
 */
class unknown_qtype_test extends \logstore_xapi\xapi_test_case {
