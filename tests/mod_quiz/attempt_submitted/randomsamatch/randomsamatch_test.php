...
namespace logstore_xapi\mod_quiz\attempt_submitted\randomsamatch;
...
/**
 * Unit test for mod_quiz attempt submitted (randomsamatch) event.
 *
 ...
 */
class randomsamatch_test extends \logstore_xapi\xapi_test_case {
