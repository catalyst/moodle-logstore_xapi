...
namespace logstore_xapi\mod_quiz\attempt_submitted\essay_null_response;
...
/**
 * Unit test for mod_quiz attempt submitted (essay null response) event.
 *
 ...
 */
class essay_null_response_test extends \logstore_xapi\xapi_test_case {
