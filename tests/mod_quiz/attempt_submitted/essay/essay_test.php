...
namespace logstore_xapi\mod_quiz\attempt_submitted\essay;
...
/**
 * Unit test for mod_quiz attempt submitted (essay) event.
 *
 ...
 */
class essay_test extends \logstore_xapi\xapi_test_case {
