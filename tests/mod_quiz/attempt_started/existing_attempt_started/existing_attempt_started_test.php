...
namespace logstore_xapi\mod_quiz\attempt_started\existing_attempt_started;
...
/**
 * Unit test for mod_quiz attempt started event.
 *
 ...
 */
class existing_attempt_started_test extends \logstore_xapi\xapi_test_case {
