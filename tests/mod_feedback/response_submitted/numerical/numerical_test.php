...
namespace logstore_xapi\mod_feedback\response_submitted\numerical;
...
/**
 * Unit test for mod_feedback response (numerical) submitted event.
 *
 ...
 */
class numerical_test extends \logstore_xapi\xapi_test_case {
