...
namespace logstore_xapi\mod_feedback\response_submitted\textarea_anon;
...
/**
 * Unit test for mod_feedback response (textarea) submitted event.
 *
 ...
 */
class textarea_test extends \logstore_xapi\xapi_test_case {
