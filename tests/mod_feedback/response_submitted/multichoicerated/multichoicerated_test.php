...
namespace logstore_xapi\mod_feedback\response_submitted\multichoicerated;
...
/**
 * Unit test for mod_feedback response (multichoicerated) submitted event.
 *
 ...
 */
class multichoicerated_test extends \logstore_xapi\xapi_test_case {
