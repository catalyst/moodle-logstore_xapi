...
namespace logstore_xapi\core_h5p\course_module_viewed\user_viewed_h5p;
...
/**
 * Unit test for h5p module viewed event.
 *
 * @package   logstore_xapi
 * @copyright Milt Reder <milt@yetanalytics.com>
 * @license   https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class user_viewed_h5p_test extends \logstore_xapi\xapi_test_case {
