...
namespace logstore_xapi\mod_hvp\attempt_submitted\common;
...
/**
 * Unit test for mod_hvp attempt submitted (common question types) event.
 *
 ...
 */
final class common_test extends \logstore_xapi\xapi_test_case {
    /**
