...
namespace logstore_xapi\core\user_loggedinas\existing_user_loggedinas;
...
/**
 * Unit test for user logged in as event.
 *
 * @package   logstore_xapi
 * @copyright Milt Reder <milt@yetanalytics.com>
 * @license   https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class existing_user_loggedinas_test extends \logstore_xapi\xapi_test_case {
